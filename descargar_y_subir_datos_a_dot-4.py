...
# password = '1b3f30e43a100e92f5df0b6453fa69f3afd8d5fe'


url = 'https://dot4-21-ene-25-18208434.dev.odoo.com/'
db = 'dot4-21-ene-25-18208434'
username = 'admin'#'admin@dot4.odoo.com'
password = 'ce28cad3a58967a9fe3408d0cb9dd0e0c87d5667'
...
def remove_none_values(data):
    """
    Elimina los valores None de un diccionario.
    """
    ...
    for model, records in datos.items():
        for record in records:
            try:
                ...
                record = remove_none_values(record)
...
def descargar_datos_y_guardar(models, db, uid, password, campos_de_los_modelos, output_file):
    ...
    for model, fields in campos_de_los_modelos.items():
        try:
            ...
            records = models.execute_kw(db, uid, password, model, 'search_read', [[('name', '=', 'FA-A 00012-00000011')]], {'fields': fields})
