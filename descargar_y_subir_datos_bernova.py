...
password = '25985115cfee23052074ca65d90b0be3291d3d75' #clave api 29/08/24
...
def descargar_datos_y_guardar(models, db, uid, password, campos_de_los_modelos, output_file):
    ...
    for model, fields in campos_de_los_modelos.items():
        try:
            ...
            records = models.execute_kw(db, uid, password, model, 'search_read', [[('type', 'in', ('contact', 'delivery'))]], {'fields': fields})#############################################
